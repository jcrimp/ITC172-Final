...
public class LoginClass
{
    ...
    private void GetUserInfo()
    {
        ...
        //query the fields
        var info = from c in showTrackerDb.FanLogins
                   where c.FanLoginUserName.Equals(username)
                   select new { c.FanLoginHashed, c.FanLoginRandom, c.FanKey };//FanLoginRandom is the random number
